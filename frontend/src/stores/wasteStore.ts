...
const mockWasteReports: WasteReport[] = [
  {
    ...
    statusHistory: [
      { status: "novo", timestamp: new Date("2024-01-15T08:30:00"), note: "Registro recebido via aplicativo" },
      {
        ...
        note: "Classificado como prioridade média",
        responsibleId: "func-001",
      },
    ],
  ...
  },
  {
    ...
    statusHistory: [
      ...
      { status: "triado", timestamp: new Date("2024-01-14T16:30:00"), note: "Requer caçamba especial" },
      {
        ...
        note: "Coleta agendada para 17/01",
        responsibleId: "func-002",
      },
    ],
  ...
  },
  {
    ...
    statusHistory: [
      ...
      { status: "agendado", timestamp: new Date("2024-01-14T08:00:00") },
      {
        ...
        note: "Equipe Alpha a caminho",
        responsibleId: "func-003",
      },
    ],
  ...
  },
  {
    ...
    coordinates: { lng: -47.8905, lat: -15.794 },
    ...
    statusHistory: [
      ...
      { status: "em_rota", timestamp: new Date("2024-01-14T10:00:00") },
      {
        ...
        note: "Coletado e enviado para reciclagem",
  ...
  },
  {
    ...
    recurrence: "frequente",
    status: "novo",
    statusHistory: [{ status: "novo", timestamp: new Date("2024-01-15T12:00:00"), note: "Registro recebido" }],
...
const mockRecyclableOffers: RecyclableOffer[] = [
  {
    ...
    coordinates: { lng: -47.888, lat: -15.795 },
  ...
  },
  {
    ...
    coordinates: { lng: -47.886, lat: -15.797 },
          ...
          wasteReports: state.wasteReports.map((report) =>
            report.id === id
              ? {
                  ...report,
                  status,
                  statusHistory: [...report.statusHistory, { status, timestamp: new Date(), note }],
                  updatedAt: new Date(),
                }
              : report,
          ),
