...
export const occurrenceStatuses = [
  ...
  },
  {
    ...
    description:
      "Esta situação foi avaliada e será tratada em momento oportuno ou já está contemplada em planejamento existente.",
    color: "#94a3b8",
  },
] as const;
...
export const appInfo = {
  ...
  privacyNote:
    "Seus dados são tratados com respeito à LGPD. Não compartilhamos informações pessoais sem consentimento.",
};
